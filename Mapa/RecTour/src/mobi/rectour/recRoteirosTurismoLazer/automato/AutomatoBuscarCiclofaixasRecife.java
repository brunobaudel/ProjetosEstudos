...
public class AutomatoBuscarCiclofaixasRecife {
	...
	public AutomatoBuscarCiclofaixasRecife(){
	...
	public void executar(){
		...
		new BuscarCiclofaixasRecife().execute();
	}
	
	
	

	private class BuscarCiclofaixasRecife extends AsyncTask<Void, Boolean, Boolean> {
