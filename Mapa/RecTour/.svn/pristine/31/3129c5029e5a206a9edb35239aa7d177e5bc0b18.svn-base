...
public class AtualizacaoADPT extends CursorAdapter {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		//String lugar = tabela + "\n" + DateUtils.getRelativeTimeSpanString(context, data) + "\n" + descricao ;
		//((TextView) view.findViewById(R.id.tvNome)).setText(lugar);
		
		
		//DateUtils.getRelativeTimeSpanString(data));
		TextView tvNomeTabela;
		//http://developer.android.com/reference/android/text/format/DateUtils.html
		(tvNomeTabela =(TextView) view.findViewById(R.id.tvNomeLocalizador)).setText(tabela);
		tvNomeTabela.setTag(tabela);
