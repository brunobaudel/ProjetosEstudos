...
public class AutomatoBuscarRestauranteFour {
	...
	public AutomatoBuscarRestauranteFour(){
			...
			if (!is.isFalhaRequisicao()) {
				...
				try {
					...
					for (int i = 0; i < arrRestaurantes.length(); i++) {
						...
						//AutomatoBuscarVenueMapping automatoVenue = new AutomatoBuscarVenueMapping(latLng, restaurante.getRtNome(), c);
